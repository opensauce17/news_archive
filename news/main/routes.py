...
def index():
    ...
    return render_template('main/index.html', username=username, user_data=user_data, default_settings=default_settings,
                           news_type=news_type, today=today, location=location, total_au_headlines_titles=total_au_headlines_titles,
                           ...
                           total_au_entertainment_sources=total_au_entertainment_sources)
